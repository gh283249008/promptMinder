...
const ANTHROPIC_API_URL = process.env.ANTHROPIC_BASE_URL || 'https://api.minimaxi.com/anthropic/v1';
...
async function tryAiConversion(source, conversation) {
  ...
  try {
    ...
    const anthropic = new Anthropic({ apiKey, baseURL: ANTHROPIC_API_URL });
